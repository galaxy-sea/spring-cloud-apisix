 ...
 */
public class ApisixApiFeignClientConfigurer {
	...
	@Bean
	public RequestInterceptor apisixTokenRequestInterceptor(ApisixDiscoveryProperties apisixDiscoveryProperties) {
		return new ApisixTokenRequestInterceptor(apisixDiscoveryProperties);
	}
