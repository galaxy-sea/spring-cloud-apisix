...
public class ApisixAutoConfiguration {
	...
	public ApisixClient apisixDiscovery(UpstreamApi upstreamApi, RouteApi routeApi, ControlApi controlApi,
		...
		return new ApisixClient(upstreamApi, routeApi, controlApi, routeCustomizerList, upstreamCustomizerList,
				objectMapper);
	}
